...
<!-- All patterns are self-contained in this file; no external references needed -->
...
<!-- See Task Creation examples above -->
...
<!-- See Timeout Handling examples above -->
...
<!-- See Advanced Patterns examples above -->
...
<!-- See Concurrency Patterns examples above -->
...
<!-- See Synchronization examples above -->
...
<!-- See Real-World Applications examples above -->
