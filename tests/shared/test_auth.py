...
from shared.api.auth import get_auth_context, get_user_id, require_context_tier, verify_user_access
...
class TestGetAuthContext:
    ...
    def test_get_auth_context_success(self):
        ...
        # Assert
        assert result == {"user_id": user_id, "context_tier": 2, "email": "test@example.com"}
...
class TestVerifyUserAccess:
    ...
    def test_verify_user_access_success(self):
        ...
        # Arrange
        user_id = uuid4()
        auth_context = {"user_id": user_id, "context_tier": 2, "email": "test@example.com"}
