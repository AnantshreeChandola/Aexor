...
from components.ProfileStore.domain.models import (
    PreferenceDB, PreferenceRequest, ConsentDeniedError,
    UserNotFoundError, UnknownPreferenceError, ValidationError
)
...
class TestSchemaRegistry:
    ...
    def test_schema_registry_initialization(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            schema_path = os.path.join(temp_dir, "test_key.json")
...
class TestDatabaseAdapter:
    ...
    async def mock_db_adapter(self):
        ...
        adapter.upsert_preference = AsyncMock(return_value=PreferenceDB(
            preference_id=uuid4(),
